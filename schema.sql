...
SELECT manager_name, COUNT(*) AS Manager_Count FROM tbl_manages GROUP BY manager_name;

SELECT manager_name, COUNT(*) AS Manager_Count FROM tbl_manages GROUP BY manager_name HAVING COUNT(*) > 1;
